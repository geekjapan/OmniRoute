...
const RAW_CONFIGS: TokenExtractionConfig[] = [
  ...
  // M365 Copilot Web stays manual-only until a verified browser origin and token
  // source are captured in repo artifacts. Do not add guessed extraction surfaces.
